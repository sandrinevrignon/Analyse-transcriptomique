...
def recup_info_chem(name):
    ...
    print("\tBat_M\tBat_M_rep1\t/scratch/assemblage_$SLURM_JOB_USER/Bat457_1.trimmed.fastq\t/scratch/assemblage_$SLURM_JOB_USER/Bat457_2.trimmed.fastq")
    print("\tBat_M\tBat_M_rep2\t/scratch/assemblage_$SLURM_JOB_USER/Bat458_1.trimmed.fastq\t/scratch/assemblage_$SLURM_JOB_USER/Bat458_2.trimmed.fastq")
    print("\tBat_F\tBat_F_rep1\t/scratch/assemblage_$SLURM_JOB_USER/Bat467_1.trimmed.fastq\t/scratch/assemblage_$SLURM_JOB_USER/Bat467_2.trimmed.fastq")
    print("\tBat_F\tBat_F_rep2\t/scratch/assemblage_$SLURM_JOB_USER/Bat468_1.trimmed.fastq\t/scratch/assemblage_$SLURM_JOB_USER/Bat468_2.trimmed.fastq")
    print("...")
