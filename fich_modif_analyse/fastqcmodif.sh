...
scp -r /projects/medium/SahelpalmsRNAseq/Sandrine/essai_prog/jeu_assemblage/* assemblage_$SLURM_JOB_USER/
...
scp -r Fastqc /projects/medium/SahelpalmsRNAseq/Sandrine/essai_prog/jeu_assemblage 
